...
function FolderViewContent() {
  ...
  return (
    <div className="relative min-h-screen w-full">
        ...
        {/* Gallery / Our Previous Work – project-linked gallery images */}
        {projectGalleryImages.length > 0 && (
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/80 mb-6 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-amber-50/90 to-orange-50/90">
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                {projectGalleryImages.slice(0, 10).map((img) => (
                  <a
                    ...
                    className="block aspect-square rounded-lg overflow-hidden border border-gray-200 hover:border-green-power-400 transition-colors focus:outline-none focus:ring-2 focus:ring-green-power-500"
                  >
                    <img src={img.url} alt={img.title || img.category} className="w-full h-full object-cover" />
                  </a>
                ))}
              </div>
              ...
              <Link
                href="/s-gallery"
                className="inline-block mt-3 text-sm font-medium text-green-power-600 hover:text-green-power-700"
              >
