  ...
  return (
    <div className="min-h-[50vh] flex flex-col items-center justify-center px-4 bg-transparent">
      <div className="text-center max-w-md">
        <h2 className="text-lg font-semibold text-gray-900 mb-2">Project could not load</h2>
        <p className="text-sm text-gray-600 mb-6">
          Something went wrong loading this project. You can try again or return to the dashboard.
        </p>
